...
public class TestSuite
{
   ...
   public static void main(String[] args)
   {
      ...
      try
      {
         ...
         reg.registerPlugin(new Plugin.Directory(f.toURI().toURL()));

         reg.registerPlugin(new Plugin.Maven("uk.ac.gate.plugins", "annie", "8.5"));
         reg.registerPlugin(new Plugin.Maven("uk.ac.gate.plugins", "tools", "8.5"));
